  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        ...
        <a href="<?= base_url('admin/requests/export_all');?>" class="btn btn-info waves-effect pull-right" ><i class="material-icons">archive</i> EXPORT ALL</a>
          ...
          <tbody>
			...
			?>
	              <tr class="<?= $row['mark_read']?'':'unread'; ?>">
	                ...
	                <td><?= $row['email']; ?></td>
	                <td>
	                	<a title="View" class="view btn btn-sm btn-info" href="<?php echo base_url('admin/requests/view/'.$row['id']);?>"> 
	                		<i class="material-icons">visibility</i>
	                	</a>
	                	
	                	<a title="Delete" class="delete btn btn-sm btn-danger" data-href="<?php echo base_url('admin/requests/del/'.$row['id']); ?>" data-toggle="modal" data-target="#confirm-delete"> 
...
<div id="confirm-delete" class="modal fade" role="dialog">
  ...
  <script>
    ...
    $('#btn_export').on('click', function(e) {
       ...
       $.ajax({
          type:'POST',
          url:'<?= base_url('admin/requests/export') ?>',
          data:{details:data},
       	  dataType: "json",
